            ...
            <div
              className={`absolute top-1.5 w-8 h-8 rounded-xl bg-gradient-to-r transition-all duration-500 ease-out ${
                isDark
                  ...
                  : "left-[2.4rem]  from-yellow-400 via-orange-400 to-red-500 shadow-lg shadow-orange-500/30"
              } group-hover:shadow-2xl`}
            />
            <div className="relative flex items-center justify-center w-8 h-8 rounded-xl z-10">
              <Moon
                className={`w-4 h-4 transition-all duration-500 ${
                  isDark
                    ? "text-white scale-110 rotate-0 opacity-100"
